...
[![Status](https://img.shields.io/badge/status-4.0.0-rc.4%20early%20development-yellow.svg)](#project-status)
...
**Version 4.0.0-rc.4 — early development.** The core (`semiring`, `wfst`, `lattice`, `algorithms`,
