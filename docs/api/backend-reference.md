...
| Property | Value |
|----------|-------|
| Intern | $`\mathcal{O}(1)`$ average |
| Lookup | $`\mathcal{O}(1)`$ |
| Memory | $`\mathcal{O}(n)`$ where $`n`$ = unique words |
...
| Property | Value |
|----------|-------|
| Intern | $`\mathcal{O}(n)`$ (linear search) |
| Lookup | $`\mathcal{O}(1)`$ |
| Memory | $`\mathcal{O}(n)`$ |
| Thread Safety | ExternalSync |
...
| Property | Value |
|----------|-------|
| Intern | $`\mathcal{O}(1)`$ + network |
| Lookup | $`\mathcal{O}(1)`$ cached / network |
...
|---------|--------|--------|--------|-------------|------------|-------------|
| HashMapBackend | $`\mathcal{O}(1)`$ | $`\mathcal{O}(1)`$ | High | No | No | No |
| VecBackend | $`\mathcal{O}(n)`$ | $`\mathcal{O}(1)`$ | Low | No | No | No |
| PathMapBackend | Net | Net/$`\mathcal{O}(1)`$ | Bounded | Yes | Yes | Yes |
| SharedBackend | $`\mathcal{O}(1)`$* | $`\mathcal{O}(1)`$* | High | Yes | No | No |
| CachedBackend | Net | $`\mathcal{O}(1)`$/Net | Medium | No | Depends | Depends |
