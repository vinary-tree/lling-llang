...
|---|---|
| Node.js | `>= 22.14` |
| `@vinary-tree/vinary-tree-interop` | exact `4.0.0-rc.5` (guards + shared types) |
| `@vinary-tree/javascript-runtime` | exact `4.0.0-rc.5` (the shared runtime that hosts the native code) |
| Package version | `4.0.0-rc.5` — always equal to the Rust crate version |
...
- Package `4.0.0-rc.5` = crate `4.0.0-rc.5`; native ABI v1, API revision 5 — the same
